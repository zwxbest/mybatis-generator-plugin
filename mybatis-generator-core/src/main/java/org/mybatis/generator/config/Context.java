...
public class Context extends PropertyHolder {
    ...
    //todo:
    private Boolean xmlMergeable;
    private Boolean javaMergeable;
    ...
    public void addProperty(String name, String value) {
        ...
        //todo:
        else if (PropertyRegistry.XMLMERGEABLE.equals(name)
                && stringHasValue(value)) {
            xmlMergeable = isTrue(value);
        }
        else if (PropertyRegistry.JAVAMERGEABLE.equals(name)
                && stringHasValue(value)) {
            javaMergeable = isTrue(value);
        }
    }
